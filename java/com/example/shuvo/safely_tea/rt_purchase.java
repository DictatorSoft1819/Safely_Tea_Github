...
public class rt_purchase  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rt_purchase);
        ...
        adapter=new ArrayAdapter<String>(rt_purchase.this,android.R.layout.simple_spinner_item,Unit);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alert=new AlertDialog.Builder(rt_purchase.this);
                        ...
                        switch (position){
                            case 0:
                                final Dialog dialog = new Dialog(
                                        rt_purchase.this);
                                dialog.setContentView(R.layout.rt_purchase_payment);
